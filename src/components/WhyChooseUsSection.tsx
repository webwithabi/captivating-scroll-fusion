...
const WhyChooseUsSection = () => {
  ...
  const reasons = [
    ...
    },
    {
      ...
      description: "We take the time to understand your unique needs and deliver customized solutions.",
      icon: <Users className="h-10 w-10 text-primary" />
    },
    {
      id: 4,
      title: "Innovation",
      description: "We're always looking for new and better ways to solve problems and deliver results.",
      icon: <Star className="h-10 w-10 text-primary" />
    }
  ];

  return (
    <section id="why-choose-us" className="section py-[8px]">
        ...
        {reasons.map((reason, index) => (
          ...
          >
            ...
            <div>
              ...
              <p className="text-foreground/70 font-semibold">{reason.description}</p>
            </div>
          </motion.div>
        ))}
      </div>
